...
namespace WordTest
{
    ...
    class WordDocument
    {
        ...
        public void ReplaceAllStrings(string strToFind, string replaceStr)
        {
            ...
            {
                string generated = replaceStr;
                string zNewReplacement;
                int a = (generated.Length / 230)+1;
                for (int i = 0; i < a; i++)
                {
                    if (generated.Length < 230)
                    {
                        zNewReplacement = generated;
                    }
                    else
                    {
                        zNewReplacement = generated.Substring(0, 230) + "{{{continue_continue}}}";
                        generated = generated.Remove(0, 230);
                    }                    
                    ReplaceAllStrings(strToFind, zNewReplacement);
                    strToFind = "{{{continue_continue}}}";
                }
            }
            else
            {
